    ...
    <div id="dashboard">
        <section>
            ...
            <div class="col2">
                ...
                <!-- No postings -->
                <div v-else>
                    <p class="no-results">No Posting yet!</p>
                </div>
            </div>
        </section>
    ...
    export default {
        ...
        methods: {
            ...
            showNewPosts(){
                ...
                console.log("updatedPostsArray[0].content: " + updatedPostsArray[0].content)
                console.log("updatedPostsArray[0].createdOn: " + updatedPostsArray[0].createdOn)
                console.log("JSON TO STRING showpost" + JSON.stringify(updatedPostsArray[0]))
                //clear hiddenposts arraya nd update posts array
                let updatedPostsArray_
                this.$store.commit('setHiddenPosts', null)
                this.$stroe.commit('setPosts', updatedPostsArray)
            }, 
